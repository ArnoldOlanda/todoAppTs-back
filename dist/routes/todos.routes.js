...
], todo_controller_1.getTodos);
router.get("/today/:id", [
    // validarJWT,
    (0, express_validator_1.check)("id", "Id is required").not().isEmpty(),
    (0, express_validator_1.check)("id").custom(middlewares_1.userIdExists),
    validarCampos_1.validarCampos,
], todo_controller_1.getTodosToday);
router.post("/", [
    // validarJWT,
...
router.put("/update/:id", [
    ...
    (0, express_validator_1.check)("description", "Description is required").not().isEmpty(),
    validarCampos_1.validarCampos,
], todo_controller_1.putTodo);
router.put("/complete/:id", [
    //validarJWT,
    (0, express_validator_1.check)("id").isNumeric(),
    (0, express_validator_1.check)("id").custom(middlewares_1.todoIdExists),
    validarCampos_1.validarCampos,
], todo_controller_1.putCompleteTodo); //Complete a todo
